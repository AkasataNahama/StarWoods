...
import nahama.starwoods.generate.WorldGenStarTreeNatural;
...
public class StarTreeSaplingNatural extends BlockSapling implements IGrowable, IPlantable {

	public StarTreeSaplingNatural() {
		super();
	...
	public Item getItemDropped(int meta, Random random, int fotune) {
		return Item.getItemFromBlock(StarWoodsBlockCore.saplingStarWoods[0]);
	}
	...
	protected boolean generateTree(World world, int x, int y, int z, Random random, int meta) {
		return new WorldGenStarTreeNatural().generate(world, random, x, y, z);
	}
